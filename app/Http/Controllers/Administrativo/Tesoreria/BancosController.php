...
class BancosController extends Controller
{
    ...
    public function movAccountLibros(Request $request){
        ...
        if (strlen($rubroPUC->code) == 4) return $this->findlvl3($rubroPUC, $fechaIni, $fechaFin);
        elseif (strlen($rubroPUC->code) == 6) return $this->findlvl4($rubroPUC, $fechaIni, $fechaFin);
    ...
    public function findlvl4($rubroPUC, $fechaIni, $fechaFin){

    }

    public function findlvl3($cuenta, $fechaIni, $fechaFin){
