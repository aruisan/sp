...
{
    public function __construct(int $año, $codigos, $valoresIniciales, $valoresFinAdd, $valoresAdd, $valoresFinRed, $valoresRed, $valoresFinCred, $valoresCred, $valoresFinCCred, $valoresCcred,
        ...
        $this->año = $año;$this->codigos = $codigos;$this->valoresIniciales = $valoresIniciales;$this->valoresFinAdd = $valoresFinAdd;$this->valoresAdd = $valoresAdd;
    ...
    {
        $meses = $this->fecha_inicio." - ".$this->fecha_final;
