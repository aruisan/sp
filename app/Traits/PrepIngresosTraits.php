            ...
            if ($data->id == 1){
                ...
                if (count($hijos1) > 0){
                    ...
                    if (isset($sum)){
                        ...
                        if ($data->code == '1.1.01.02.200') dd("SECOND", $compIngValue, $civ);
                        ...
                        if (count($rubro) == 1){
                            if (count($rubro[0]->fontsRubro) > 1){
                                foreach ($rubro[0]->fontsRubro as $font){
                                    ...
                                    if ($data->code == '1.1.01.02.200') dd("third",$data, $compIngValue, $compIngValueArray);
                                ...
                                if (count($rubro[0]->fontsRubro) > 0){
                                    ...
                                    if ($data->code == '1.1.01.02.200') dd("FOURTH",$data, $compIngValue, $compIngValueArray);
