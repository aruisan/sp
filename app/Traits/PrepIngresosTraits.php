                    ...
                    foreach ($hijos1 as $h1){
                        ...
                        if ($data->name == 'INGRESOS CORRIENTES' and $h1->id == 48){
                            foreach ($hijos2 as $hijoRev){
                                ...
                                if ($hijoRev->code = 'TASAS Y DERECHOS ADMINISTRATIVOS') dd($hijos3Rev, $hijoRev);
                                            ...
                                            if ($h4Rev->hijo == 0){
                                                ...
                                                if (count($hijos5Rev) > 0) {
                                                    foreach ($hijos5Rev as $h5Rev){
                                                        if ($h5Rev->hijo == 0){
                                                            $hijos6Rev = PlantillaCuipoIngresos::where('padre_id', $h5Rev->id)->get();
                                                            if (count($hijos6Rev) > 0) {
                                                                foreach ($hijos6Rev as $h6Rev) {
                                                                    $getDataFunction = $this->getData($vigencia, $h6Rev, $inicio, $final);
