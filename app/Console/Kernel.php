...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        //$schedule->command('validate:saldosRPs')->everyMinute()->appendOutputTo(storage_path('logs/feedPresupuesto.log'));
        //$schedule->command('validate:saldosRubros')->everyMinute()->appendOutputTo(storage_path('logs/feedPresupuesto.log'));
    }
