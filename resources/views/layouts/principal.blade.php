       ...
       otro elemento que se pueda ocultar al minimizar la barra -->
            <div class="collapse navbar-collapse navbar-ex1-collapse" id="navbarSupportedContent">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                      <a href="" class="btn btn-link text-white item-menu" data-toggle="modal" data-target="#modal-Politicas">POLITICsadasdAS</a>
                    </li>
                    @auth
                        <li class="page-scroll">
                    ...
                    @else
                        ...
                        <li class="page-scroll">
                            <a href="{{ url('/register') }}" class="btn btn-link text-white item-menu">REGISTRO IMPUESTOS</a>
                        </li>
                    @endauth
                    <li class="page-scroll">
