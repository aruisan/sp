	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-4 s7">
				<img src="https://presupuesto.providenciaislas.com.co/img/escudoIslas.png"  height="60">
			</div>
			<div class="col-md-4 s57">
				<p>
					...
					MUNICIPIO DE PROVIDENCIA ISLAS Y SANTA CATALINA<br>
					</b>
				</p>
			</div>
			<div class="col-md-4 s7">
				<img src="https://presupuesto.providenciaislas.com.co/img/masporlasislas.png"  height="60">
			</div>
		</div>
		@yield('contenido')
	</div>
