...
<title>empleados sueldos import</title>
...
{{--
<form method="post" action="{{route('import.reintegro')}}" enctype="multipart/form-data">
{{ csrf_field() }}
...
<script>
    ...
    var hot = new Handsontable(container, {
        ...
        rowHeaders: true,
        //colHeaders: ['cedula','sueldo'],
        colHeaders: ['cedula','prima', 'fecha ingreso'],
        filters: true,
        dropdownMenu: true,
        contextMenu:true,
        formulas:true
    ...
    const guardar = async () => {
        ...
        */
        let resp = await fetch('{{route('import.empleado.sueldo')}}', {
            headers:{
