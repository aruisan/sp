...
@section('titulo')  EDITAR REGISTRO DE ATRAQUE DE EMBARCACIONES @stop
            ...
            <div class="tab-content">
                ...
                <div class="col-lg-12">
                    <div class="form-validation">
                        <form class="form-valide" action="{{url('/administrativo/impuestos/muellaje/'.$muellaje->id)}}" method="POST" enctype="multipart/form-data" id="prog">
                            {!! method_field('PUT') !!}
                            {{ csrf_field() }}
                            <table id="TABLA1" class="table text-center">
                                <tbody>
                                <tr style="background-color: #0e7224; color: white">
                                    <th scope="row" colspan="3">REGISTRO DE INGRESO EMBARCACIÓN Y LIQUIDACION IMPUESTO MUELLAJE {{ $muellaje->numRegistroIngreso }}</th>
                                </tr>
                            ...
                            <table class="table text-center">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input class="form-control" type="text" name="name" id="name" required value="{{$muellaje->name}}"></td>
                                    <td>Bandera</td>
                                ...
                                <tr>
                                    ...
                                    <td><select class="form-control" id="exclusive" name="exclusive" onchange="changeExclusive(this.value)">
                                            <option @if($muellaje->exclusive == 'NO') selected @endif value="NO">NO</option>
                                            <option @if($muellaje->exclusive == 'SI') selected @endif value="SI">SI</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Tipo de Carga</td>
                                    <td colspan="3"><input class="form-control" type="text" name="tipoCarga" id="tipoCarga" required value="{{$muellaje->tipoCarga}}"></td>
                                    <td>Tonelaje Carga</td>
                                    <td><input class="form-control" type="number" min="0" value="{{$muellaje->tonelajeCarga}}" name="tonelajeCarga" id="tonelajeCarga" required></td>
                                </tr>
                                <tr>
                                    <td>Número de Tripulantes</td>
                                    <td><input class="form-control" type="number" value="{{$muellaje->tripulantes}}" min="1" name="tripulantes" id="tripulantes" required></td>
                                    <td>Número de pasajeros</td>
                                    <td><input class="form-control" type="number" value="{{$muellaje->pasajeros}}" min="0" name="pasajeros" id="pasajeros" required></td>
                                ...
                                <tr>
                                    <td>NIT/CC</td>
                                    <td colspan="3"><input class="form-control" type="number" name="numIdent" id="numIdent" required value="{{$muellaje->numIdent}}"></td>
                                    <td>Fecha permiso</td>
                                    <td><input type="date" class="form-control" name="fechaPermiso" id="fechaPermiso" required value="{{ \Carbon\Carbon::parse($muellaje->fechaPermiso)->format('Y-m-d') }}"></td>
                                </tr>
                                <tr>
                                    <td colspan="2">Titular del permiso</td>
                                    <td colspan="4"><input class="form-control" type="text" name="titularPermiso" id="titularPermiso" value="{{$muellaje->titularPermiso}}" required></td>
                                ...
                                @foreach($muellaje->vehiculosRelation as $vehiculo)
                                    <tr>
                                        <td>
                                            ...
                                            <button type="button" @click.prevent="eliminarVehiculo({{ $vehiculo->id }})" class="btn btn-sm btn-primary-impuestos"><i class="fa fa-trash"></i></button>
                                        </td>
                                        <td>Número de vehículos</td>
                                        <td><input class="form-control" type="number" value="{{ $vehiculo->vehiculos }}" min="0" name="vehiculos[]" id="vehiculos"></td>
                                        <td>Clase vehiculo</td>
                                        <td><input class="form-control" type="text" name="claseVehiculo[]" id="claseVehiculo" value="{{ $vehiculo->claseVehiculo }}"></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                            <table class="table text-center">
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" name="nameCap" id="nameCap" value="{{$muellaje->nameCap}}" required></td>
                                    <td>Móvil</td>
                                    <td><input class="form-control" type="number" name="movilCap" id="movilCap" value="{{$muellaje->movilCap}}" required></td>
                                </tr>
                                <tr>
                                    <td>Compañía o empresa propietario</td>
                                    <td><input class="form-control" type="text" name="nameCompany" id="nameCompany" value="{{$muellaje->nameCompany}}" required></td>
                                    <td>Móvil</td>
                                    <td><input class="form-control" type="number" name="movilCompany" id="movilCompany" value="{{$muellaje->movilCompany}}" required></td>
                                </tr>
                                <tr>
                                    <td>Correo electrónico</td>
                                    <td colspan="3"><input class="form-control" type="email" name="emailCap" id="emailCap" value="{{$muellaje->emailCap}}" required></td>
                                </tr>
                                </tbody>
                            </table>
                            <table class="table text-center">
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" name="nameNaviera" id="nameNaviera" value="{{$muellaje->nameNaviera}}" required></td>
                                    <td>NIT</td>
                                    <td><input class="form-control" type="number" name="NITNaviera" id="NITNaviera" required value="{{$muellaje->NITNaviera}}"></td>
                                </tr>
                                <tr>
                                    <td>Nombre representante Legal</td>
                                    <td><input class="form-control" type="text" name="nameRep" id="nameRep" required value="{{$muellaje->nameRep}}"></td>
                                    <td>CC/NIT/CE</td>
                                    <td><input class="form-control" type="number" name="idRep" id="idRep" required value="{{$muellaje->idRep}}"></td>
                                </tr>
                                <tr>
                                    <td>Dirección Notificación</td>
                                    <td><input class="form-control" type="text" name="dirNotificacion" id="dirNotificacion" value="{{$muellaje->dirNotificacion}}" required></td>
                                    <td>Municipio</td>
                                    <td><input class="form-control" type="text" name="municipio" id="municipio" value="{{$muellaje->municipio}}" required></td>
                                </tr>
                                <tr>
                                    <td>Correo electrónico</td>
                                    <td colspan="3"><input class="form-control" type="email" name="emailNaviera" id="emailNaviera" value="{{$muellaje->emailNaviera}}" required></td>
                                </tr>
                                </tbody>
                            </table>
                            <table class="table text-center" id="tablePay">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input class="form-control" type="text" name="nameRepPago" id="nameRepPago" value="{{$muellaje->nameRepPago}}" required></td>
                                </tr>
                                <tr>
                                    <td>Fecha de Atraque</td>
                                    <td><input class="form-control" type="date" name="fechaAtraque" id="fechaAtraque" value="{{ \Carbon\Carbon::parse($muellaje->fechaAtraque)->format('Y-m-d') }}" required></td>
                                    <td>Fecha de Salida</td>
                                    <td><input class="form-control" type="date" name="fechaSalida" id="fechaSalida" min="{{ Carbon\Carbon::today()}}" value="{{ \Carbon\Carbon::parse($muellaje->fechaSalida)->format('Y-m-d') }}" required></td>
                                </tr>
                                <tr>
                                    <td>Hora de Ingreso</td>
                                    <td><input class="form-control" type="time" name="horaIngreso" id="horaIngreso" value="{{$muellaje->horaIngreso}}" required></td>
                                    <td>Hora de salida</td>
                                    <td><input class="form-control" type="time" name="horaSalida" id="horaSalida" value="{{$muellaje->horaSalida}}" required></td>
                                </tr>
                                <tr>
                                    <td>Días Permanencia</td>
                                    <td><input class="form-control" type="number" value="{{$muellaje->numTotalDias}}" onchange="changeDays(this.value)" name="numTotalDias" id="numTotalDias" min="0" required></td>
                                    <td>Horas Permanencia</td>
                                    <td><input class="form-control" onchange="changeHours(this.value)" type="number" value="{{$muellaje->numHoras}}" name="numHoras" id="numHoras" min="0" max="7" required></td>
                                </tr>
                                <tr>
                                    <td colspan="2">Tarifa</td>
                                    <td colspan="2">
                                        <input class="form-control" type="hidden" name="tarifa" id="tarifa" min="0" value="{{$muellaje->tarifa}}" step=".001">
                                        <span id="tarifaSpan">{{$muellaje->tarifa}} USD</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">Valor del Dolar Diario</td>
                                    <td colspan="2">
                                        <input class="form-control" type="text" name="valorUSD" id="valorUSD" value="{{ $muellaje->valorDolar }}">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input class="form-control" type="hidden" name="valorPago" id="valorPago" min="1" value="{{$muellaje->valorPago}}" step=".001" required>
                                        <h3><span id="valorPagoSpan">{{$muellaje->valorPago}} $</span></h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Observaciones</td>
                                    <td colspan="3"><textarea class="form-control" type="text" name="observaciones" id="observaciones">{{$muellaje->observaciones}}</textarea></td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <button type="submit" class="btn btn-impuesto" style="font-size: 25px; color: white">ACTUALIZAR</button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
