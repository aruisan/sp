                                    ...
                                    @if($fuenteAgua)
                                        <div class="row">
                                            <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                    <input type="number" class="form-control" id="value_fuente" name="value_fuente" required min="0" style="text-align: center">
                                                </div>
                                            ...
                                            <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="actividad" class="form-control">
                                                        ...
                                                        <option value="25">A.3.11.5 ALCANTARILLADO-PREINVENSIONES, ESTUDIOS</option>
                                                        <option value="26">A.3.11.5 ALCANTARILLADO-PREINVENSIONES, ESTUDIOS</option>
                                                    </select>
                                                </div>
